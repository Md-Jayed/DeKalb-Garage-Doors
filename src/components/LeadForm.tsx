    ...
    return (
      <div className={`bg-emerald-50 border border-emerald-200 rounded-2xl p-6 md:p-8 text-center shadow-md animate-fadeIn ${className}`}>
        ...
        <p className="text-emerald-800 text-sm mt-3 leading-relaxed">
          Thank you, <strong>{formData.name}</strong>. Our local DeKalb service coordinator has received your request for <strong>{formData.serviceNeeded}</strong>.
        </p>
      ...
      <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-4">
        ...
        <div className="flex items-start gap-2.5 mt-1">
          ...
          <label htmlFor="agreedToTerms" className="text-[10px] md:text-xs text-slate-500 leading-tight">
            I agree to receive SMS notifications or phone calls from DeKalb Garage Door Repair to coordinate services. Message & data rates may apply.
          </label>
        </div>
