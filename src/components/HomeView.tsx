      ...
      <section className="relative bg-slate-900 py-12 lg:py-20 overflow-hidden text-white min-h-[600px] flex items-center">
        ...
        <div className="absolute inset-0 z-0 select-none pointer-events-none opacity-40">
          <img
            ...
            alt="Premium Garage Door in DeKalb IL"
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10 w-full grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            <span className="inline-block text-xs md:text-sm font-black text-amber-400 uppercase tracking-widest bg-amber-950/60 px-3 py-1.5 rounded-full border border-amber-800/40 w-fit">
              ★ Same-Day Service in DeKalb & Surrounding Areas ★
            </span>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-black tracking-tight leading-tight md:leading-none text-slate-100">
              Fast & Reliable Garage Door Repair in <span className="text-amber-400">DeKalb, IL</span>
            </h2>
      ...
      <section className="py-16 md:py-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-slate-600 text-sm md:text-base mt-4 leading-relaxed">
              We take immense pride in our workmanship. See what our local customers in DeKalb, Sycamore, Cortland, and surrounding Northern Illinois communities are saying about our rapid service.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 md:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex flex-col gap-5 text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">
            Serving DeKalb, IL & Surrounding Communities
          </h2>
          <p className="text-slate-600 text-sm md:text-base leading-relaxed">
            We are centrally located in DeKalb, allowing our emergency repair vehicles to reach nearby Sycamore, Cortland, Malta, Genoa, Hinckley, Kingston, and Maple Park within approximately 45-60 minutes.
          </p>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col gap-4 mt-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-xs text-slate-500 block mt-0.5">1100 Lincoln Hwy, DeKalb, IL 60115</span>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:8155558240" className="text-xs font-bold text-blue-950 block mt-0.5 hover:text-amber-500 transition-colors">
                  (815) 555-8240
                </a>
              </div>
            </div>
        ...
        {/* Right Column (Secure Google Map Iframe representing DeKalb, IL) */}
        <div className="bg-white border border-slate-200 rounded-3xl p-3 shadow-md h-[380px] overflow-hidden relative">
          <iframe
            title="Google Map DeKalb IL"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d47458.10651877028!2d-88.750365!3d41.929474!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x880efdfdbb39cd01%3A0x633bdff6f753cbe0!2sDeKalb%2C%20IL!5e0!3m2!1sen!2sus!4v1700000000000!5m2!1sen!2sus"
            width="100%"
            height="100%"
